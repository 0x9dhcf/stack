...
void GetWMHints(Window w, int *h);

void GetWMProtocols(Window w, int *h);
...
void GetNetWMWindowType(Window w, int *h);

void GetNetWMState(Window w, int *h);

void SetNetWMState(Window w, int h);
